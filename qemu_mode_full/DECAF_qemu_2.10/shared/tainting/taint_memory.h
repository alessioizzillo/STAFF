...
//zyw
extern void __taint_ldb_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_ldw_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_ldl_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_ldq_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_ldb_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
extern void __taint_ldw_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
extern void __taint_ldl_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
extern void __taint_ldq_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);

extern void __taint_stb_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_stw_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_stl_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_stq_raw(int d, unsigned long addr, gva_t vaddr, uint8_t end);
extern void __taint_stb_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
extern void __taint_stw_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
extern void __taint_stl_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
extern void __taint_stq_raw_paddr(int d, ram_addr_t addr,gva_t vaddr, uint8_t end);
